...
function TeacherForm() {
  ...
  const scheduleItemsDefault = { week_day: 0, from: '', to: '', };
  const [scheduleItems, setScheduleItems] = useState([scheduleItemsDefault]);

  function addNewScheduleItem() {
    setScheduleItems([ ...scheduleItems, scheduleItemsDefault ]);
  }
  ...
  function setScheduleItemValue(index: number, field: string, value: string) {
    const updatedScheduleItem = scheduleItems.map((item, position) => {
      if (index === position) {
